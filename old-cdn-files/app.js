// Vue.js Application for Resume Website
const { createApp } = Vue;

// Data section - All your resume information
const resumeData = {
...
createApp({
  ...
  methods: {
    ...
    // Method to handle experience selection
    selectExperience(experience) {
      this.selectedExperience = experience;
      this.currentPage = "experience";
    },

    // Method to go back to experience list
    backToExperiences() {
  ...
  updated() {
    // Animate progress bars when skills page is loaded
  ...
  computed: {
    // Computed property for filtered experiences
    filteredExperiences() {
      return this.experiences;
    },

    // Computed property for total years of experience
    totalExperience() {
